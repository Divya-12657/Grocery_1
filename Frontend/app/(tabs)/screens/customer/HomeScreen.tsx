...
//           <Text style={styles.headerText}>Fresh Market</Text>
...
//                     <TouchableOpacity
//                       style={[styles.quantityButton, quantityInCart === 0 && styles.quantityButtonDisabled]}
//                       onPress={() => {
...
//                     >
//                       <Text style={[styles.quantityButtonText, quantityInCart === 0 && styles.quantityButtonTextDisabled]}>−</Text>
//                     </TouchableOpacity>
...
//                           // You can optionally add fallback UI here
//                         }}
//                       />
//                     ) : (
//                       <LinearGradient
...
export default function HomeScreen({ navigation }) {
  ...
  // Helper to remove backend prefix from image_url
  const cleanImageUrl = (url) => {
    const prefix = 'http://localhost:5000/store-images/';
