...
# order = Orders()
# print(hasattr(order, 'user_id'))
# print(hasattr(order, 'user'))

# app = Flask(__name__)


# app.secret_key = 'your_secret_key'
# # postgresql://divs:foodforthought@51.20.74.48/Grocery_Market
...
# print(type(User))        # Should print: <class 'models.User'>
...
# Remove these problematic lines that create instances outside app context
# order = Orders()
# print(hasattr(order, 'user_id'))
# print(hasattr(order, 'user'))
...
def admin_dashboard():
    ...
    orders_data = []
    for order in orders:
        # Use the correct relationship name from your Orders model
...
def generate_sales_content(df, orders):
    ...
    if 'branch_id' in df.columns and df['branch_id'].notna().any():
        ...
        html6 = '<div class="chart"><p style="text-align: center; padding: 50px; color: #7f8c8d;">📍 Branch data not available</p></div>'
